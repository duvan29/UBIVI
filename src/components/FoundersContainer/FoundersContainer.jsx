      ...
      <div className={styles.vismeContainer}>
          <div dangerouslySetInnerHTML={{
            __html: `
              ...
              <iframe id="embedded-project-iframe" title="ubivi" src="//my.visme.co/_embed/pvjqdm6g-ubivi" style="border: 0; width: 80%; height: 100%; padding-bottom: 56.25%;" webkitallowfullscreen="true" mozallowfullscreen="true" allowfullscreen=""></iframe>
